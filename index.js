...
app.on('ready', () => {
  ...
  // mainWindow.loadURL(isDev ? 'https://localhost:8080/editor/' : `file://${path.join(__dirname, '../src/index.html')}`);
...
const createWindow = () => {
  ...
  if(isDev){
    ...
    mainWindow.loadURL(`http://175.27.245.116:8085`)
    // mainWindow.loadURL('http://175.27.245.116:8085/')
    mainWindow.loadFile(`src/index.html`)
  }else{
    console.log('isnotDev')
   // mainWindow.loadFile(`src/index.html`)
    mainWindow.loadURL(`http://175.27.245.116:8085`)
  }
